  ...
  try {
    ...
    await prisma.$executeRawUnsafe(`
      ALTER TABLE "BorewellWork"
        ...
        ADD COLUMN IF NOT EXISTS "diesel_liters" DECIMAL(10,2),
        ADD COLUMN IF NOT EXISTS "diesel_rate" DECIMAL(10,2),
        ADD COLUMN IF NOT EXISTS "diesel_amount" DECIMAL(14,2),
